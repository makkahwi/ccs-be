...
export interface ApiCurrencyCurrency extends Schema.CollectionType {
  ...
  attributes: {
    ...
    mostRecentEdition: Attribute.Integer &
      Attribute.Required &
      Attribute.SetMinMax<{
        min: 1;
      }>;
    fractionName: Attribute.String & Attribute.Required;
    fraction: Attribute.Integer & Attribute.Required;
    exchange_rate: Attribute.Relation<
    ...
    editions: Attribute.Relation<
      'api::currency.currency',
      'oneToMany',
      'api::currency-edition.currency-edition'
    >;
    currency_zone: Attribute.Relation<
      'api::currency.currency',
      'manyToOne',
      'api::currency-zone.currency-zone'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiCurrencyEditionCurrencyEdition
  extends Schema.CollectionType {
...
export interface ApiCurrencyZoneCurrencyZone extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Required;
    mapCode: Attribute.String & Attribute.Required & Attribute.Unique;
...
export interface ApiExchangeRateExchangeRate extends Schema.CollectionType {
  ...
  attributes: {
    valuePerUsd: Attribute.Decimal & Attribute.Required;
    currency: Attribute.Relation<
      'api::exchange-rate.exchange-rate',
      'oneToOne',
      'api::currency.currency'
...
export interface ApiPiecePiece extends Schema.CollectionType {
  ...
  attributes: {
    ...
    frontPhoto: Attribute.Media;
    backPhoto: Attribute.Media;
    type: Attribute.Enumeration<['Coin', 'Banknote']> & Attribute.Required;
    collection: Attribute.Relation<
      'api::piece.piece',
      'oneToOne',
      'api::collection.collection'
    >;
    currency_edition: Attribute.Relation<
      'api::piece.piece',
      'manyToOne',
      'api::currency-edition.currency-edition'
    >;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::currency-edition.currency-edition': ApiCurrencyEditionCurrencyEdition;
      'api::currency-zone.currency-zone': ApiCurrencyZoneCurrencyZone;
